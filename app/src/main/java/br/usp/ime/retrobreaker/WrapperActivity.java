...
public class WrapperActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Game.State.enableSoundEffects(mSoundEffectsCheckBox.isChecked());
    ...
    public void onCheckBoxClicked(View view) {
        ...
        Game.State.enableSoundEffects(checked);
